  ...
  return {
    ...
    exposed_operations: {
      bulk_players: {
        ...
        scope: "player cards plus their evolution wiring: players, evo_paths, evo_version_updates, evo_step_updates. Collections, packs, teams, challenges and every other group are rejected with PLAYERS_ONLY_SCOPE — use /bulk or /content-release for those.",
        duplicate_names: "two brand-new cards may intentionally share a name (evo versions): send action=\"create\" or allow_duplicate_name=true on each and neither is resolved by name",
